...
/*	wsocket = new SockJS(
	...
	/*wsocket = new SockJS(
			"http://192.168.20.46:9090/tpm_project/project-sockjs.do?project_idx="+project_idx);
			
			*/
	
	wsocket = new SockJS(
			"http://192.168.0.38:9090/tpm_project/project-sockjs.do?project_idx="+project_idx)
