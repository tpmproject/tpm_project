									...
									<div id="project_div${i.project_idx}" class="col-lg-3"
										...
										<div class="box" style="border: 0px;">
											<div class="box-gray aligncenter" style="height: 210px;">
												...
												<c:choose>
													<c:when
														test="${i.project_level == 3000 and i.project_state == 3}">
														<button type="button">완료</button>
													</c:when>
													<c:when
														test="${i.project_level == 3000 and i.project_state == 2 }">
														<td><input type="button" value="평가 대기"
															onclick="location.href='projectEvaluation.do?project_idx=${i.project_idx}&project_level=${i.project_level}&member_idx=${s_member_idx}'"></td>
													</c:when>
											...
											<div class="box-bottom">
												<a
													href="projectContent.do?project_idx=${i.project_idx}&member_idx=${s_member_idx}">프로젝트보기버튼</a>
											</div>
										</div>
									</div>
									<!-- divider -->
										...
										<div class="panel panel-danger coupon">
											...
											<div class="panel-body">
												<img src="http://i.imgur.com/e07tg8R.png"
													class="coupon-img img-rounded" width="500px" height="250px">
											...
											<div class="panel-footer">
												<div class="coupon-code">
													업무확인 <span class="print"> <a href="#"
														class="btn btn-link"><i class="fa fa-lg fa-print"></i>평가하기</a>
													</span>
												</div>
											</div>
										</div>
