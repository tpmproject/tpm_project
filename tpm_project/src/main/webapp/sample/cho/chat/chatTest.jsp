...
<link href="/tpm_project/sample/cho/chat/chatTest_css.css" rel="stylesheet" />
...
<script type="text/javascript" src="/tpm_project/sample/cho/chat/chatTest_js.js"></script>
			...
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p>I am being lazy and do not want to program an "Add User"
							section into this snippet... So it looks like you'll have to do
							that for yourself.</p>
						<br />
						<p>
