	...
	<div class="container">
		<div class="row">
			<div class="col-md-4 text-center">
				<div class="well">
					<a href="http://develoteca.com"> <img
						src="http://develoteca.com/wp-content/themes/site/img/develoteca.png" />
						<br />by develoteca.com
					</a>

				</div>
				<a
					href="https://github.com/oscaruhp/chatSocketAchex/archive/gh-pages.zip"
					class="btn3d btn btn-success btn-lg">Download v1.0</a> <br />
				<br />
				<script async
				...
				<ins class="adsbygoogle"
					...
					data-ad-client="ca-pub-4331617637495482" data-ad-slot="7438564459"></ins>
				<script>
(adsbygoogle = window.adsbygoogle || []).push({});
  ...
  fjs.parentNode.insertBefore(js, fjs);
					...
					<div class="fb-comments"
						data-href="http://oscaruhp.github.io/chatSocketAchex/"
						data-width="300" data-numposts="5"></div>
				</div>
			</div>
			...
			<div class="col-md-8">
				...
				<h1 class="text-center">
					<span style="color: #449D44">chatSocketAchex</span> jQuery Plugin
				</h1>
   ...
   $('#Elchat').ChatSocket();
				...
				<h2>Options</h2>
				you can custom by passing options when call the plugin, all
				available options are listed below. call the the plugin on a
				container wish you wish
