			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="/tpm_project/sample/cho/main/dist/img/user2-160x160.jpg" class="user-image"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header"><img
							src="/tpm_project/sample/cho/main/dist/img/user2-160x160.jpg" class="img-circle"
							alt="User Image">
							<p>
