<html>
  ...
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
  	...
  	<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css?ver=1">
	<!-- custom scrollbar stylesheet -->
	<link rel="stylesheet" href="/tpm_project/sample/cho/scroll/jquery.mCustomScrollbar.css?ver=2">
 ...
 <body>
   ...
   <!-- Google CDN jQuery with fallback to local -->
	...
	<script>window.jQuery || document.write('<script src="/tpm_project/sample/cho/scroll/js/minified/jquery-1.11.0.min.js"><\/script>')</script>
	
	<!-- MaxCDN Bootstrap plugins -->
	<script src="http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min.js"></script>
	
	<!-- custom scrollbar plugin -->
	<script src="/tpm_project/sample/cho/scroll/jquery.mCustomScrollbar.concat.min.js"></script>
