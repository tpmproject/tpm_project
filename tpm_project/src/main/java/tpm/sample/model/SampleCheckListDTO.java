...
public class SampleCheckListDTO {
	...
	public SampleCheckListDTO() {
		super();
	}

	public SampleCheckListDTO(int checklist_idx, int work_idx, String checklist_content, int checklist_state) {
		super();
	...
	public String toString() {
		return "SampleCheckListDTO [checklist_idx=" + checklist_idx + ", work_idx=" + work_idx + ", checklist_content="
