...
public class WorkDTO {
	...
	final public static int WORK_NEED_CONFIRM=10; //결재필요 업무
	final public static int WORK_NO_CONFIRM=20; //결재 불필요 업무
	
	final public static int WORK_ING=1; //결재 요청전 상태, 진행중
	final public static int WORK_CONFIRM_WAIT=2; //결재 대기
	final public static int WORK_CONFIRM_FIN=3; //결재 안료
